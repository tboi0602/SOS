...
export const adminMembershipController = {
  async getSettings(req: Request, res: Response, next: NextFunction) {
    try { res.json(await flowService.getSettings()) }
    catch (err) { next(err) }
  },

  async updateFlow(req: Request, res: Response, next: NextFunction) {
    try { res.json(await flowService.updateFlow(req.body)) }
    catch (err) { next(err) }
  },
  ...
  async updateLesson(req: Request, res: Response, next: NextFunction) {
    try { res.json(await lessonService.updateLesson(pid(req, "id"), req.body)) }
    catch (err) { next(err) }
  },

  async deleteLesson(req: Request, res: Response, next: NextFunction) {
    try { res.json(await lessonService.deleteLesson(pid(req, "id"))) }
    catch (err) { next(err) }
  },

  async createQuizQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.createQuizQuestion(req.body)) }
    catch (err) { next(err) }
  },

  async updateQuizQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.updateQuizQuestion(pid(req, "id"), req.body)) }
    catch (err) { next(err) }
  },

  async deleteQuizQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.deleteQuizQuestion(pid(req, "id"))) }
    catch (err) { next(err) }
  },

  async createSituationQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await situationService.createSituationQuestion(req.body)) }
    catch (err) { next(err) }
  },

  async updateSituationQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await situationService.updateSituationQuestion(pid(req, "id"), req.body)) }
    catch (err) { next(err) }
  },

  async deleteSituationQuestion(req: Request, res: Response, next: NextFunction) {
    try { res.json(await situationService.deleteSituationQuestion(pid(req, "id"))) }
    catch (err) { next(err) }
  },
  ...
  async getPendingDocs(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(await flowService.getPendingDocs(page, limit))
    } catch (err) { next(err) }
  },
  ...
  async getPendingPayments(req: Request, res: Response, next: NextFunction) {
    try {
      const page = Math.max(1, n(req.query.page, 1))
      const limit = Math.min(50, Math.max(1, n(req.query.limit, 20)))
      res.json(await flowService.getPendingPayments(page, limit))
    } catch (err) { next(err) }
  },
  ...
  async approveDocs(req: Request, res: Response, next: NextFunction) {
    try { res.json(await flowService.approveDocs(pid(req, "userId"), req.user!.userId)) }
    catch (err) { next(err) }
  },
  ...
  async rejectDocs(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(await flowService.rejectDocs(pid(req, "userId"), s(adminNote)))
    } catch (err) { next(err) }
  },

  async verifyPayment(req: Request, res: Response, next: NextFunction) {
    try { res.json(await flowService.verifyPayment(pid(req, "userId"), req.user!.userId)) }
    catch (err) { next(err) }
  },
  ...
  async rejectPayment(req: Request, res: Response, next: NextFunction) {
    try {
      const { adminNote } = req.body
      res.json(await flowService.rejectPayment(pid(req, "userId"), s(adminNote)))
    } catch (err) { next(err) }
  },
  ...
  async scoreLesson(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(await lessonService.scoreLesson(pid(req, "lessonId"), n(score), s(adminNote) || undefined))
    } catch (err) { next(err) }
  },
  ...
  async scoreSituation(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(await situationService.scoreSituation(pid(req, "userId"), situationIndex, n(score), s(adminNote) || undefined))
    } catch (err) { next(err) }
  },

  async completeFlow(req: Request, res: Response, next: NextFunction) {
    try { res.json(await flowService.completeFlow(pid(req, "userId"))) }
    catch (err) { next(err) }
  },
  ...
  async createExamSet(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.createExamSet(req.body)) }
    catch (err) { next(err) }
  },

  async updateExamSet(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.updateExamSet(pid(req, "id"), req.body)) }
    catch (err) { next(err) }
  },

  async deleteExamSet(req: Request, res: Response, next: NextFunction) {
    try { res.json(await quizService.deleteExamSet(pid(req, "id"))) }
    catch (err) { next(err) }
  },
  ...
  async addQuestionsToExamSet(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      res.json(await quizService.addQuestionsToExamSet(pid(req, "id"), questionIds ?? []))
    } catch (err) { next(err) }
  },
  ...
  async getExamSets(req: Request, res: Response, next: NextFunction) {
    try {
      const flowId = s(req.query.membershipFlowId) || (await flowService.getDefaultFlow()).id
      res.json(await quizService.getExamSets(flowId))
    } catch (err) { next(err) }
  },
}
