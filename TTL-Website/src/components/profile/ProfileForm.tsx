...
import { Loader2, Save, User, Globe, MessageCircle } from "lucide-react";
...
const socialFields = [
  { label: "Facebook", key: "facebook" as const, icon: Globe, placeholder: "https://facebook.com/..." },
  { label: "Twitter", key: "twitter" as const, icon: Globe, placeholder: "https://twitter.com/..." },
  { label: "TikTok", key: "tiktok" as const, icon: Globe, placeholder: "https://tiktok.com/..." },
  { label: "YouTube", key: "youtube" as const, icon: Globe, placeholder: "https://youtube.com/..." },
  { label: "Zalo", key: "zalo" as const, icon: MessageCircle, placeholder: "Số điện thoại Zalo" },
];

export default function ProfileForm({
  name, job, address, bio, saving, msg, error,
  ...
  saving: boolean; msg: string; error: string;
      ...
      <div className="p-5 sm:p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          <div className="space-y-1.5 sm:col-span-2">
            ...
            <input type="text" value={name} onChange={(e) => onNameChange(e.target.value)} required className={inputStyle} />
          </div>
