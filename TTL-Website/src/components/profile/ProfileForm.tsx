      ...
      <div className="p-5 sm:p-6 space-y-5">
        ...
        <div className="space-y-3">
          <div className="space-y-1.5">
            <label className="text-[10px] text-[var(--text-tertiary)] font-bold tracking-wider uppercase">Họ và tên</label>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label className="text-[10px] text-[var(--text-tertiary)] font-bold tracking-wider uppercase">Công việc</label>
              <input type="text" value={job} onChange={(e) => onJobChange(e.target.value)} placeholder="Chuyên viên Sales" className={inputStyle} />
            </div>
            <div className="space-y-1.5">
              <label className="text-[10px] text-[var(--text-tertiary)] font-bold tracking-wider uppercase">Địa chỉ</label>
              <input type="text" value={address} onChange={(e) => onAddressChange(e.target.value)} placeholder="Hồ Chí Minh" className={inputStyle} />
            </div>
          </div>
          <div className="space-y-1.5">
            <label className="text-[10px] text-[var(--text-tertiary)] font-bold tracking-wider uppercase">Giới thiệu</label>
        ...
        <div className="border-t border-[var(--border-base)] pt-5">
          <h2 className="text-[11px] font-bold tracking-[0.15em] text-[var(--clr-accent)] flex items-center gap-2 mb-3">
            <Globe size={12} /> MẠNG XÃ HỘI
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {socialFields.map((s) => (
              <div key={s.label} className="space-y-1">
                <label className="text-[10px] text-[var(--text-tertiary)] font-bold tracking-wider uppercase">{s.label}</label>
                <input
                  type="text"
