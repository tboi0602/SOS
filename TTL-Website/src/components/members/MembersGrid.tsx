          ...
          return (
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 1px 3px color-mix(in srgb, var(--clr-primary) 8%, transparent)",
              }}
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "var(--surface-strong)";
                e.currentTarget.style.boxShadow =
                  "0 8px 30px color-mix(in srgb, var(--clr-primary) 14%, transparent)";
              }}
              onMouseLeave={(e) => {
            ...
            >
              <div className="shrink-0">
                {m.avatar ? (
                  <Image
                    ...
                    width={40}
                    height={40}
                    className="size-10 rounded-xl object-cover transition-all"
                    style={{ boxShadow: "0 0 0 1px var(--border-base)" }}
                  />
                ) : (
              ...
              <div className="flex-1 min-w-0 grid grid-cols-7 gap-2 items-center">
                <div className="col-span-2 min-w-0">
                  <p
                    className="text-sm font-semibold group-hover:text-accent transition-colors truncate"
                ...
                <div className="col-span-4 grid grid-cols-5 gap-1.5 text-center">
                  ...
                  >
                    ...
                    <p
                      className="text-[8px] flex items-center justify-center gap-0.5"
                      style={{ color: "var(--text-tertiary)" }}
                    >
                      <Shield size={8} /> KL
                    </p>
