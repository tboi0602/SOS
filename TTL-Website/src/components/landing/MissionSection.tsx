  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 80% 50% at 50% 100%, var(--mesh-1), transparent 60%)",
        }}
      />
      <SectionGlow
        position="center"
          ...
          {MISSION.items.map((item, i) => (
            ...
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-accent/10 mb-5 ring-1 ring-accent/10 group-hover:ring-accent/30 group-hover:scale-110 transition-all duration-300">
                <span className="text-2xl font-extrabold text-accent">T</span>
              </div>
              <h3
              ...
              <div
                className="h-px mx-auto mb-3 max-w-8 transition-all duration-300"
                style={{
                  background:
