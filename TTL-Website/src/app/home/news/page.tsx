...
export default function NewsPage() {
  const { posts, loading, toggleLike, addComment, deleteComment, deletePost } = useNews();
      ...
      <div className="max-w-3xl mx-auto space-y-8">
        ...
        <Skeleton name="post-card" loading={loading} rows={posts.length || 3}>
          {posts.length === 0 ? (
            ...
            <div ref={listRef} className="space-y-4 animate-[fadeIn_0.5s_ease-out]">
              {posts.map((post) => (
