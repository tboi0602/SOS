      ...
      <Skeleton name="admin-dashboard" loading={loading}>
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <StatCard label="Tổng thành viên" value={stats.total} rawValue={stats.total} icon={Users} color="from-accent to-accent-dark" />
            <StatCard label="Đang hoạt động" value={stats.active} rawValue={stats.active} icon={Award} color="from-emerald-400 to-emerald-600" />
            <StatCard label="Tổng điểm" value={stats.totalScore.toLocaleString("vi-VN")} rawValue={stats.totalScore} icon={TrendingUp} color="from-amber-400 to-amber-600" />
            <StatCard label="Bài viết" value={stats.totalPosts.toLocaleString("vi-VN")} rawValue={stats.totalPosts} icon={FileText} color="from-accent-light to-accent" />
          </div>

          <ChartSection pointChartData={pointChartData} activityChartData={activityChartData} />
